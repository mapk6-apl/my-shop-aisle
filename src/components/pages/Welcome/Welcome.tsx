...
export const Welcome = () => {
  ...
  return (
    <div id='welcome-page'>
        <TextComponent style={{fontSize: '40px', textAlign: 'center', marginTop: '20px'}}>My Shopping Aisle</TextComponent>
        ...
        <TextComponent variant='p'>By joining My Shopping Aisle you agree to our Terms of Service, Privacy Policy, and Acts Policy.</TextComponent>
    </div>
  )
}